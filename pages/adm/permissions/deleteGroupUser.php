<?php
    headerr('Delete permission', 'permissions.delete.groupUser');
?>
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT id FROM group_userGroup WHERE id = :id";
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            $stmt = $pdo->prepare('DELETE FROM group_userGroup WHERE id = :id');
    ...
    <div class="center">
        <div class="permissionDelete">
            ...
            <?php else : ?>
                ...
                <div class="yesno">
                    <a class="yes" href="index.php?page=adm/<?= basename(__DIR__) ?>/deleteGroupUser&id=<?= $contact['id'] ?>&confirm=yes">Yes</a>
