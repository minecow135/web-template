...
<div class="content-wrapper">
    <div class="center">
        ...
        <form class="registerCode_new" action="" method="post">
            <table class="registerCode_new">
                <thead>
                    <tr>
        ...
        <?php
            if (!empty($active)) {
        ?>
            <form class="registerCode" action="" method="post">
                <table class="registerCode">
                    <thead>
                        <tr>
                            <td>Code</td>
                            <td>Total uses</td>
        ...
        ?>
            <p class="noCode">There are no active codes now. Create one</p>
        <?php
            }
        ...
        ?>
            <p class="noCode">There are no codes here now</p>
        <?php
            }
        ?>
    </div>
